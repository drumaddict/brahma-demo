...
ActiveRecord::Schema.define(version: 20151122233305) do
  ...
  create_table "page_type_hierarchies", id: false, force: :cascade do |t|
    t.integer "ancestor_id",   limit: 4, null: false
    t.integer "descendant_id", limit: 4, null: false
    t.integer "generations",   limit: 4, null: false
  end

  add_index "page_type_hierarchies", ["ancestor_id", "descendant_id", "generations"], name: "page_type_anc_desc_idx", unique: true, using: :btree
  add_index "page_type_hierarchies", ["descendant_id"], name: "page_type_desc_idx", using: :btree

  create_table "page_type_translations", force: :cascade do |t|
  ...
  add_index "page_type_translations", ["locale"], name: "index_page_type_translations_on_locale", using: :btree
  add_index "page_type_translations", ["page_type_id"], name: "index_page_type_translations_on_page_type_id", using: :btree
  ...
  add_index "page_types", ["parent_id"], name: "index_page_types_on_parent_id", using: :btree
  add_index "page_types", ["public"], name: "index_page_types_on_public", using: :btree
  add_index "page_types", ["slug"], name: "index_page_types_on_slug", unique: true, using: :btree

  create_table "page_types_pages", id: false, force: :cascade do |t|
    t.integer "page_type_id", limit: 4
    t.integer "page_id",      limit: 4
  end

  add_index "page_types_pages", ["page_id"], name: "index_page_types_pages_on_page_id", using: :btree
  add_index "page_types_pages", ["page_type_id"], name: "index_page_types_pages_on_page_type_id", using: :btree
